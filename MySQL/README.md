...
Ambos archivos usan SQL clasico y legible. No contienen comentarios ejecutables
del tipo `/*! ... */`: las configuraciones necesarias se muestran como sentencias
`SET` normales, y los comentarios que empiezan con `--` son solamente explicativos.
