...
function m({ className: e, ...t }) {
	return /* @__PURE__ */ (0, p.jsx)("svg", {
		...
		children: /* @__PURE__ */ (0, p.jsxs)("g", {
			...
			children: [
				/* @__PURE__ */ (0, p.jsxs)("g", {
					className: "blueeco-whale__spout",
					strokeWidth: "2.3",
					children: [
						/* @__PURE__ */ (0, p.jsx)("path", { d: "M76 28C71 22 71 17 75 13" }),
						/* @__PURE__ */ (0, p.jsx)("path", { d: "M82 27C84 20 88 18 92 17" }),
						/* @__PURE__ */ (0, p.jsx)("path", { d: "M79 20C79 15 81 12 83 10" })
					]
				}),
				...
				/* @__PURE__ */ (0, p.jsxs)("g", {
					className: "blueeco-whale__tail",
					fill: "#e9f6ff",
					strokeWidth: "2.7",
					children: [/* @__PURE__ */ (0, p.jsx)("path", { d: "M116 59C127 56 132 49 133 41C142 43 148 50 148 59C138 59 130 63 120 68Z" }), /* @__PURE__ */ (0, p.jsx)("path", { d: "M120 66C131 64 141 67 146 75C137 79 127 77 116 71Z" })]
				}),
				...
				/* @__PURE__ */ (0, p.jsx)("path", {
					d: "M76 77C84 84 92 88 100 83C97 75 90 70 82 68",
					fill: "#d9f0ff",
					strokeWidth: "2.5"
				}),
				/* @__PURE__ */ (0, p.jsx)("path", {
					d: "M47 55C51 59 56 59 60 55",
					strokeWidth: "2.5"
				}),
				/* @__PURE__ */ (0, p.jsx)("path", {
					d: "M43 66C48 71 54 71 59 67",
					strokeWidth: "2.2"
				}),
				/* @__PURE__ */ (0, p.jsx)("path", {
					d: "M69 35C84 32 99 37 108 47",
					stroke: "#7fbaf2",
					strokeWidth: "1.7"
				}),
				/* @__PURE__ */ (0, p.jsx)("path", {
					d: "M22 98C29 92 35 104 42 98C49 92 55 104 62 98",
					stroke: "#58b8ef",
					strokeWidth: "2"
				}),
				/* @__PURE__ */ (0, p.jsx)("path", {
					d: "M66 102C73 96 79 108 86 102C93 96 99 108 106 102",
					stroke: "#58b8ef",
					strokeWidth: "2"
				}),
				/* @__PURE__ */ (0, p.jsx)("path", {
					d: "M111 97C118 91 124 103 131 97C138 91 144 103 151 97",
					stroke: "#58b8ef",
					strokeWidth: "2"
				})
			]
...
//#endregion
//#region src/components/loading/LoadingScreen.tsx
function h({ isLoading: e, progress: t = 0, label: n = "Cargando simulación...", errorMessage: r = null, className: i = "" }) {
	let [a, o] = (0, d.useState)(e), [s, c] = (0, d.useState)(!1);
	if ((0, d.useEffect)(() => {
		let t = 0, n = 0;
		return e ? (o(!0), t = window.requestAnimationFrame(() => c(!0))) : (c(!1), n = window.setTimeout(() => o(!1), 420)), () => {
			window.cancelAnimationFrame(t), window.clearTimeout(n);
		};
	}, [e]), !a) return null;
	let l = Math.round((t == null ? 0 : Math.min(1, Math.max(0, t))) * 100), u = { "--blueeco-progress": `${l}%` };
	return /* @__PURE__ */ (0, p.jsx)("section", {
		className: `blueeco-loading${s ? " blueeco-loading--visible" : ""}${i ? ` ${i}` : ""}`,
		role: "status",
		"aria-live": "polite",
		"aria-busy": e,
		"aria-label": r ?? n,
		children: /* @__PURE__ */ (0, p.jsxs)("div", {
			className: "blueeco-loading__content",
			children: [
				/* @__PURE__ */ (0, p.jsx)("div", {
					className: "blueeco-loading__visual",
					"aria-hidden": "true",
					children: /* @__PURE__ */ (0, p.jsx)("div", {
						className: "blueeco-loading__orbit",
						children: /* @__PURE__ */ (0, p.jsx)("div", {
							className: "blueeco-loading__carrier",
							children: /* @__PURE__ */ (0, p.jsx)("div", {
								className: "blueeco-loading__whale-position",
								children: /* @__PURE__ */ (0, p.jsx)("div", {
									className: "blueeco-loading__whale-upright",
									children: /* @__PURE__ */ (0, p.jsx)(m, { className: "blueeco-loading__whale" })
								})
							})
						})
					})
				...
				/* @__PURE__ */ (0, p.jsx)("h2", {
					className: r ? "blueeco-loading__error" : void 0,
					children: r ?? n
				}),
				/* @__PURE__ */ (0, p.jsx)("div", {
				...
				/* @__PURE__ */ (0, p.jsxs)("p", {
					className: "blueeco-loading__percentage",
					children: [l, "%"]
				})
			]
		})
...
//#endregion
//#region src/simulator-loading.tsx
function g() {
	let [e, t] = (0, d.useState)(!0), [n, r] = (0, d.useState)(null), [i, a] = (0, d.useState)(null);
	return (0, d.useEffect)(() => {
		let e = () => {
			a(null), r(null), t(!0);
		}, n = (e) => {
			let { current: t = 0, total: n = 0 } = e.detail ?? {};
			r(n > 0 ? t / n : null);
		}, i = () => {
			r(1), t(!1);
		}, o = (e) => {
			let n = e.detail;
			a(n?.message ?? "No se pudo iniciar la simulación."), t(!0);
		};
		return window.addEventListener("blueeco:simulator-loading-start", e), window.addEventListener("blueeco:simulator-loading-progress", n), window.addEventListener("blueeco:simulator-loading-ready", i), window.addEventListener("blueeco:simulator-loading-error", o), () => {
			window.removeEventListener("blueeco:simulator-loading-start", e), window.removeEventListener("blueeco:simulator-loading-progress", n), window.removeEventListener("blueeco:simulator-loading-ready", i), window.removeEventListener("blueeco:simulator-loading-error", o);
		};
	}, []), /* @__PURE__ */ (0, p.jsx)(h, {
		isLoading: e,
		progress: n,
...
var _ = document.getElementById("simulator-loading-root");
_ && (0, f.createRoot)(_).render(/* @__PURE__ */ (0, p.jsx)(g, {}));
//#endregion
