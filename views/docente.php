...
$estudiantes = mysqli_query(
    ...
    "SELECT id, username, email 
     FROM usuarios 
     WHERE rol_id = " . ROL_ESTUDIANTE . " 
     ORDER BY username"
);

$simulaciones = mysqli_query(
    $conn,
...
<head>
    ...
    <link rel="stylesheet" href="../public/css/docente.css">
</head>
<body>
    ...
    <main class="contenedor-docente">
        ...
        <p class="subtitulo">
            Elige una simulación y los estudiantes que la recibirán
        </p>
        ...
        <form method="POST" id="form-asignar">
            ...
            <div class="campo">
                ...
                <div class="info-ayuda">
                    💡 Marca varios estudiantes a la vez.
                </div>
            </div>

            <button type="submit" name="asignar" class="boton-asignar">
                ✅ Asignar simulación
            </button>
        </form>
    </main>
    ...
    <script src="/Simulador-Acu-tico-main/public/js/burbujas.js"></script>
    <script src="/Simulador-Acu-tico-main/public/js/docente.js"></script>
</body>
</html>