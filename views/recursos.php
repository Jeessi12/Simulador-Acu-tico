                ...
                <article class="doc-card-fluid">
                    ...
                    <div class="doc-body-fluid">
                        ...
                        <div class="doc-actions-fluid">
                            <a href="../public/pdfs/plan-manejo-cobanos.pdf" target="_blank" rel="noopener" class="doc-btn-action view" aria-label="Ver PDF"><i class="fa-solid fa-eye"></i> Ver</a>
                            <a href="../public/pdfs/plan-manejo-cobanos.pdf" download class="doc-btn-action download" aria-label="Descargar PDF"><i class="fa-solid fa-download"></i></a>
                        </div>
                    </div>
                </article>
