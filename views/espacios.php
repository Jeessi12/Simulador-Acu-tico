...
if ($id_espacio > 0) {
    ...
    if (!$espacio_query || mysqli_num_rows($espacio_query) === 0) {
        ...
        $tareas_pendientes = mysqli_query($conn,
            "SELECT a.id, s.nombre AS sim_nombre, u.username, a.fecha_asignacion, a.estado
             FROM asignaciones a
        ...
        <div class="classroom-grid">
            ...
            <div class="classroom-card full-width">
                ...
                <form method="POST" class="assign-form">
                    ...
                    <button type="submit" name="asignar_espacio" class="btn-assign">Asignar a todos los miembros</button>
                </form>
            </div>
